...
# ---------------------
    def convert_wstates_to_gstates(self, wstates):
        """
        Given a list of WorldState instances, convert them to GlobalStates
        with dummy environments (used for further symbolic execution/fuzzing).
        """
        gstates = []
        for w in wstates:
            gstates.append(GlobalState(w, None))  # No environment needed immediately
        return gstates
# ---------------------
